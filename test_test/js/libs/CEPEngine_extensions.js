...
(function () {
    ...
    /**
     * Displays the OS File Open dialog, allowing the user to select
     ...
     *      <ul><li>"data": An array of the names of the selected files.</li>
    ...
    */
     ...
     *
     * @param url {string} The URL of the page to open. Must use HTTP or HTTPS. For example:
     *  "http://www.adobe.com"
     *
     * @return An object with this property:
     *      <ul><li>"err": The status of the operation, one of:
